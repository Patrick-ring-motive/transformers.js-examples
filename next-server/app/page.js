...
export default function Home() {
  return ( <
    ...
    >
    <
    span className = "text-4xl font-light mx-5" > & #xd7; < /span> <
    ...
    <
    a className = "rounded-full border border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
    ...
    rel = "noopener noreferrer" >
    <
    Image aria - hidden src = "/github.svg"
    alt = "GitHub icon"
    width = {
      16
    }
    ...
    rel = "noopener noreferrer" >
    <
    Image aria - hidden src = "/window.svg"
    alt = "Window icon"
    width = {
      16
    }
    ...
    rel = "noopener noreferrer" >
    <
    Image aria - hidden src = "/globe.svg"
    alt = "Globe icon"
    width = {
      16
    }
